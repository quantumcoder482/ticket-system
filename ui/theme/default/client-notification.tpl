                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td data-value="{$d['admin']}" data-sorting="false" id="img{$d['admin']}" alt="Avatar" style="text-align:center">
                                ...
                                {else}
                                <img src="{$app_url}{$d['img']}" class="img-circle" alt="{$d['replied_by']}" width="35px" height="35px">
                                {/if}

                            </td>

                            <td class="" data-value="" id="">
                                <a href="#">{$d['replied_by']}</a> has replied to your submission and awaits your response.
                                {if $d['client_read'] neq 'yes'}
                            ...
                            <td class="text-center" data-sorting="false">
                                <a href="{$_url}client/tickets/view/{$d['tid']}/comments"
...
<script type="text/javascript">
    ...
    $('#mark_read').on('click', function(e){
        $.get(_url+'client/tickets/mark_all_read', function(data){
            if($.isNumeric(data)){
                location.reload();
            }
        });
