    ...
    function loadItems() {
        ...
        $.getJSON( base_url + "items/all/", function( data ) {
            ...
            $.each( data, function( key, val ) {
                ...
                b_p = '<div class="col-lg-2 col-md-2 col-sm-3 col-xs-4"><div class="pos_item text-center"><img src="/storage/items/thumb'+ val.image +'" alt="'+ val.name +'" class="img-circle"><hr>'+ val.name +' <br>'+ val.sales_price +'  <hr></div> </div>';
